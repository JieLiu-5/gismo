...
public:
    ...
    void print_custom() const
    {
        ...
        gsInfo << "size of m_strings: " << m_strings.size() << "\n"
               << "size of m_ints: " << m_ints.size() << "\n"
               << "size of m_reals: " << m_reals.size() << "\n"
               << "size of m_switches: " << m_switches.size() << "\n"
               << "\n";
        
        gsInfo << "content of m_ints:\n";
        for (auto it = m_ints.begin(); it != m_ints.end(); it++)
        {
            gsInfo << "first: " << it->first << ", "
