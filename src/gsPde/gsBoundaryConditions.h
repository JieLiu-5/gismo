...
public:
    ...
    typedef typename std::deque<boundary_condition<T> > bcContainer;                            // boundary_condition<T> is a class defined above
...
public:
    ...
    const bcContainer & neumannSides()   const {return m_bc["Neumann"]; }                           // m_bc is of type bcData, which is an alias of std::map<std::string,bcContainer>, line 219
                                                                                                    // bcContainer is an alias of std::deque<boundary_condition<T> >, see line 206
    ...
    {
//         gsInfo << "gsBoundaryConditions<T>::print()" << "\n";
